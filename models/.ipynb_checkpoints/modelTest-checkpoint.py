...
in_channels1 = 64
in_channels2 = 64
data1 = torch.randn(batch_size, in_channels1, 100, 100)
data2 = torch.randn(batch_size, in_channels2, 50, 50)

# 初始化并前向传播
fusion_net = CrossScaleAttentionFusion(in_channels1, in_channels2)
fused_data1, fused_data2 = fusion_net(data1, data2)

print("Fused Data1 Shape:", fused_data1.shape)  # 应该是 (batch_size, 5, 100, 100)
print("Fused Data2 Shape:", fused_data2.shape)  # 应该是 (batch_size, 5, 50, 50)