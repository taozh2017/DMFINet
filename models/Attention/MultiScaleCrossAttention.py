...
class CrossAttentionBlockMutual(nn.Module):
    def __init__(self, img_size=64, img_size_y=32, patch_size=4, in_chans=128, num_classes=1000, embed_dim=2048, depth=3,
        ...
        super(CrossAttentionBlockMutual, self).__init__()
...
if __name__ == "__main__":
    cat = CrossAttentionBlockMutual(img_size=64, img_size_y=32, patch_size=4, in_chans=128, embed_dim=2048, depth=3, num_heads=8,
