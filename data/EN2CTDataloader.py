...
class MR2CT_Dataset(data.Dataset):
    def __init__(self, source_modal, target_modal, img_size,
                 image_root, mode, data_rate, sort=False, argument=False, random=False, re_augment=False,
                 re_down=False):

        self.source = source_modal
        self.target = target_modal
        self.image_size = img_size
        self.modal_list = ['ct', 'en']
    ...
    def __getitem__(self, index):
        ...
        gt = npy_two[self.modal_list.index(self.target), :, :]
        ...
        gt_B, mask_B = get_3d_mask(gt, min_=0, max_=1, th=15, width=10)
...
def get_loader(batchsize, shuffle, pin_memory=True, source_modal='en', target_modal='ct',
               img_size=256, img_root='data/', mode="test/", data_rate=1, num_workers=8, sort=False, argument=False,
...
if __name__ == '__main__':
    data_loader = get_loader(batchsize=1, shuffle=False, pin_memory=True, source_modal='en',
                             target_modal='ct', img_size=256, num_workers=8,
                             img_root='../../dataProcessed/', mode="train/", data_rate=1, argument=False, random=False)
