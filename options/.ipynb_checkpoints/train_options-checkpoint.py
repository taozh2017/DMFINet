...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--save_latest_freq', type=int, default=50000000, help='frequency of saving the latest results')
        ...
        self.parser.add_argument('--pool_size', type=int, default=15, help='the size of image buffer that stores previously generated images')
